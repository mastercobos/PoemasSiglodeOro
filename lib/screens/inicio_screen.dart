          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                ...
                icon: const Icon(Icons.tune, color: Color(0xFFD4AF6A), size: 22),
                onPressed: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const AjustesInicioScreen())),
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (destacados.isEmpty)
                  ...
                  ...destacados.map((p) =>
                      _TarjetaPoema(poema: p, todosLosPoemas: poemas)),
              ],
            ),
          ),
        );
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(_fragmento(),
                      style: GoogleFonts.lato(
                          fontSize: 15, height: 1.85, color: versoColor)),
                ),
                Align(
